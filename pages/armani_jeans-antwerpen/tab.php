...
<!--[if lt IE 10]>     <html class="no-js lt-ie9"> <![endif]-->
...
<link href='//fonts.googleapis.com/css?family=Lato:700,300' rel='stylesheet' type='text/css'>
        ...
        <style type="text/css" media="screen">
          ...
          #noie {
            ...
            width:100%;
            height:100%;
            background:url("<?php echo ($secure_connection) ? $secure_link : $insecure_link; ?>v1373965091/60_a75uxc.png") repeat top left; 
            position:absolute;
            top:0;
            left:0;
          }
    ...
    <body>
      ...
      <div id="noie">
        <div>
          ...
          <h2><a href="http://chrome.com">Why not try Chrome?</a></h2>
        </div>
      </div>
      <div id="fb-root"></div>
